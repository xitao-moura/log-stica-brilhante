...
const AddRomaneioScreen: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let data = {
        ...
        status: '64d4445df38e8309dfa3c07c'
      }

      console.log("Data POST Romaneio ", data)

      await api.post('/romaneios', data);
      
      toast.show({
        description: 'Romaneio cadastrado com sucesso',
        placement: 'top',
      });
      router.back();
    } catch (err: any) {
  ...
  return (
    <Box flex={1} bg="gray.50">
      <Box bg="white" shadow={1} px={4} py={3}>
        <HStack justifyContent="space-between" alignItems="center">
          <Text fontSize="md" fontWeight="semibold" color="gray.700">Novo Romaneio</Text>
...
export default AddRomaneioScreen;
